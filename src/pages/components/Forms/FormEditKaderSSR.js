...
export default function CardTableKaderSSR({ kader, handleUpdateDataKader }) {
    ...
    const handleUpdate = () => {
      ...
      if (confirmation) { 
        router.push('/ssr/kader'); // Redirect kembali setelah berhasil diperbarui
      }
    };
  
    const handleCancel = () => {
      router.push('/ssr/kader'); // Kembali tanpa melakukan perubahan
    };
    return (
      <>
