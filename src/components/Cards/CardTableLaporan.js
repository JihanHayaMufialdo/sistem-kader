          ...
          <table className="items-center w-full bg-white border-collapse">
            ...
            {[...laporan, ...currentItems].map((item, index) => (
                <tr key={index}>
                  ...
                  <td style={{ width: "60px" }} className="px-10 py-4 whitespace-nowrap text-center text-sm text-gray-800">{item.IK}</td>
                  <td style={{ width: "60px" }} className="px-10 py-4 whitespace-nowrap text-center text-sm text-gray-800">{item.IK_Nonrt}</td>
                  <td style={{ width: "60px" }} className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-800">{item.Ternotifikasi}</td>
                </tr>
              ))}
            </tbody>
          </table>
